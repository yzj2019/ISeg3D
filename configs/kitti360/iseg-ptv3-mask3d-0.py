...
model = dict(
    ...
    max_train_iter=3, mask_threshold=0.5
)
...
test = dict(
    ...
    semantic_ignore_label=[semantic_ignore_label], instance_ignore_label=instance_ignore_label,
    progressive_mode=False, random_clicks=False, topk_per_scene=100,
    cost_class=1., cost_focal=1., cost_dice=1.,
    ...
    train=dict(
        ...
        pointcloud_cfg = dict(
            ...
            transform=[
                ...
                dict(type="InstanceParser", segment_ignore_index=[semantic_ignore_label], instance_ignore_index=instance_ignore_label),       # 将特定的semantic label在instance中忽略
                dict(type="ToTensor"),
        ...
        pointcloud_cfg = dict(
            ...
            test_cfg=dict(
                ...
                post_transform=[
                    dict(type="CenterShift", apply_z=False),
                    dict(type="ToTensor"),
                    dict(type="Collect", keys=("coord", "discrete_coord", "index", "color", "scene_id"), feat_keys=("color", "normal"))
                ],
                aug_transform=[
