...
class SerializedPooling(PointModule):
    ...
    def forward(self, point: Point):
        ...
        # 7. 如果启用了随机打乱顺序，则对代码、顺序和逆序进行随机打乱
        ...
        # 8. 收集信息，构建一个字典，包含下采样后的特征、坐标、代码、顺序、逆序等信息
        point_dict = Dict(
...
@MODELS.register_module("PT-v3m1-fpn")
class PointTransformerV3_FPN(PointModule):
    def __init__(
        self,
        in_channels=6,
        order=("z", "z-trans"),
    ...
    def forward(self, data_dict):
        ...
        #         reduce="mean",
        #     )
        return point, self.feature_pyramid
